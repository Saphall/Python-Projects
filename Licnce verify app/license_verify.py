...
def open():
    root.filename = filedialog.askopenfilename(
        initialdir='2Licnce verify app', title='Select Driving License', filetypes=(('jpeg', '*.jpg'), ('png files', '*.png')))
...
b1 = Button(frame2, text='Capture/Open', command=open,
            width=20, borderwidth=3, bg='cyan')
